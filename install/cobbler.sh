...
if [[ $SUPPORT_UVP_11SP3 == "y" ]]; then
    ...
    download "$UVP_11SP3_IMAGE_SOURCE" -u "$UVP_11SP3_IMAGE_SOURCE_ASIA" uvp-os-11sp3-x86_64.tar.gz copy /var/www/cobbler/images/uvp-11sp3-x86_64.tar.gz || exit $?
fi
