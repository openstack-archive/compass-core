...
class TestParseDatetime(unittest2.TestCase):
    ...
    def test_incorrect_format(self):
        date_time = '2014-7-10-9:10:40'
        self.assertRaises(Exception, util.parse_datetime, date_time)
...
class TestParseDatetimeRange(unittest2.TestCase):
    ...
    def test_both_start_end_datetime(self):
        ...
        expected_datetime_range = (datetime.datetime(2014, 7, 10, 9, 10, 40),
    ...
    def test_none_start(self):
        ...
        parsed_datetime_range = util.parse_datetime_range(range)
        expected_datetime_range = (None, datetime.datetime(2014, 7, 11, 9, 10, 40))
        self.assertEqual(expected_datetime_range, parsed_datetime_range)

    def test_none_end(self):
        range = '2014-7-10 9:10:40,'
        parsed_datetime_range = util.parse_datetime_range(range)
        expected_datetime_range = (datetime.datetime(2014, 7, 10, 9, 10, 40), None)
        self.assertEqual(expected_datetime_range, parsed_datetime_range)
    ...
    def test_no_comma(self):
        range = 'dummy'
        self.assertRaises(Exception, util.parse_datetime_range, range)
...
class TestParseTimeInterval(unittest2.TestCase):
    ...
    def tearDown(self):
        super(TestPassTimeInterval, self).tearDown()
...
class TestLoadConfigs(unittest2.TestCase):
    ...
    def test_load_no_suffix(self):
        loaded = util.load_configs(self.TEST_UTIL_HOME + '/data/test_no_suffix')
        expected = []
        self.assertEqual(loaded, expected)

    def test_load_conf(self):
        loaded = util.load_configs(self.TEST_UTIL_HOME + '/data/test_load_conf')
        expected = [{'TEST': True, 'PROD': False}]
        self.assertEqual(loaded, expected)

    def test_load_confs(self):
        loaded = util.load_configs(self.TEST_UTIL_HOME + '/data/test_load_confs')
    ...
    def test_load_confs_global_env(self):
        ...
        expected = [{'UTIL_TEST': 'unittest'}, {'TEST': True, 'PROD': False}]
        loaded.sort()
        expected.sort()
        self.assertTrue(loaded, expected)
    ...
    def test_load_confs_local_env(self):
        ...
        expected = [{'TEST': True, 'UTIL_TEST': 'unittest'}, {'TEST': True, 'PROD': False}]
        loaded.sort()
        expected.sort()
        self.assertTrue(loaded, expected)
    ...
    def test_load_confs_local_env_no_override(self):
        loaded = util.load_configs(self.TEST_UTIL_HOME + '/data/test_load_confs',
                     env_globals={'TEST': False})
        expected = [{'TEST': False, 'UTIL_TEST': 'unittest'}, {'TEST': True, 'PROD': False}]
        loaded.sort()
        expected.sort()
        self.assertTrue(loaded, expected)
    ...
    def test_load_conf_error(self):
        ...
        self.assertRaises(Exception, util.load_configs, err_dir)
