...
sudo cp -rf /etc/selinux/config /root/backup/selinux/
...
sudo cp -rf /var/lib/cobbler/snippets /root/backup/cobbler/
sudo cp -rf /var/lib/cobbler/kickstarts/ /root/backup/cobbler/
...
sudo cp -rf /etc/xinetd.d/rsync /root/backup/
