...
def _obj_equal(check, obj):
    """Used by output filter to check if two object are equalent."""
    if check == obj:
        return True
...
def _list_equal(check_list, obj_list):
    """Used by output filter to check if two list are equalent."""
    return set(check_list).issubset(set(obj_list))


def _dict_equal(check_dict, obj_dict):
    """Used by output filter to check if two dict are equalent."""
