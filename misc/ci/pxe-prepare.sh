...
/usr/bin/python compass/bin/manage_db.py set_switch_machines --switch_machines_file switch-file
/usr/bin/python compass/bin/manage_db.py clean_clusters 
/usr/bin/python compass/bin/manage_db.py clean_installation_progress
