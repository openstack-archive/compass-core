...
if [ "$tempest" == "true" ]; then
    sudo yum --enablerepo=compass install -y virt-install libvirt qemu-kvm libxml2-devel libffi-devel libxslt-devel python-devel sshpass openssl-devel --nogpgcheck
    if [[ "$?" != "0" ]]; then
