...
opts = [
    ...
    cfg.StrOpt('host_networks',
               help=(
                   ...
                   '<hostname>:<interface_name>=<ip>|<is_mgmt>|,...'
               ),
               default=''),
    cfg.StrOpt('partitions',
               ...
               default='tmp:percentage=10%,var:percentage=30%,'
                       'home:percentage=30%'),
