...
def load_os_metadatas_ui_internal(force=False):
    ...
    if force or OS_METADATA_UI_MAPPING is None:
...
def load_os_metadatas_internal(force=False):
    ...
    if force or OS_METADATA_MAPPING is None:
...
def load_flavor_metadatas_ui_internal(force=False):
    ...
    if force or FLAVOR_METADATA_UI_MAPPING is None:
...
def load_package_metadatas_internal(force=False):
    ...
    if force or PACKAGE_METADATA_MAPPING is None:
...
def load_flavor_metadatas_internal(force=False):
    ...
    if force or FLAVOR_METADATA_MAPPING is None:
...
def load_flavors_internal(force=False):
    ...
    if force or FLAVOR_MAPPING is None:
...
OS_METADATA_UI_MAPPING = None
FLAVOR_METADATA_UI_MAPPING = None
FLAVOR_MAPPING = None
