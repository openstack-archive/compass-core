...
class PackageInstallerCheck(base.BaseCheck):
    ...
    def chef_check(self):
        ...
        if missing == True:
            ...
            self._set_status(0, "[Package_Installer]Error: Missing modules on chef server: %s. " % ' ;'.join(message for message in messages))
    ...
    def check_chef_data(self, data_type, github_url):
        ...
        try:
            ...
            self._set_status(0, "[Package Installer]Error: pychef is not installed.")
