...
def _update_switch_machine(updater, switch_id, machine_id, machines_fields, **kwargs):
...
def update_switch_machine(updater, switch_id, machine_id, **kwargs):
    return _update_switch_machine(
        updater, switch_id, machine_id, ALL_UPDATED_MACHINES_FIELDS, **kwargs
    )


@utils.wrap_to_dict(RESP_MACHINES_FIELDS)
@utils.input_validates(patched_lans=_check_vlans)
...
def patch_switch_machine(updater, switch_id, machine_id, **kwargs):
    return _update_switch_machine(
        updater, switch_id, machine_id, ALL_PATCHED_MACHINES_FIELDS, **kwargs
    )
