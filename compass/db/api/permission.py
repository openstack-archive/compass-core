...
PERMISSION_UPDATE_CLUSTER_HOSTS = PermissionWrapper(
    'update_cluster_hosts', 'update cluster hosts', 'update cluster hosts')
...
PERMISSION_LIST_HOST_CLUSTERS = PermissionWrapper(
    'list_host_clusters', 'list host clusters', 'list host clusters')
...
PERMISSION_LIST_HOST_NETWORKS = PermissionWrapper(
    'list_host_networks', 'list host networks', 'list host networks')
...
PERMISSION_LIST_CLUSTERHOST_CONFIG = PermissionWrapper(
    'list_clusterhost_config', 'list clusterhost config', 'list clusterhost config')
PERMISSION_ADD_CLUSTERHOST_CONFIG = PermissionWrapper(
    'add_clusterhost_config', 'add clusterhost config', 'add clusterhost config')
PERMISSION_DEL_CLUSTERHOST_CONFIG = PermissionWrapper(
    'del_clusterhost_config', 'del clusterhost config', 'del clusterhost config')
PERMISSION_GET_CLUSTERHOST_STATE = PermissionWrapper(
    'get_clusterhost_state', 'get clusterhost state', 'get clusterhost state')
PERMISSION_UPDATE_CLUSTERHOST_STATE = PermissionWrapper(
    'update_clusterhost_state', 'update clusterhost state', 'update clusterhost state')
PERMISSIONS = [
