...
if [[ $SUPPORT_CENTOS_6_5 == "y" ]]; then
    ...
    # download packages
    download $CENTOS_6_5_PPA_REPO_SOURCE unzip /var/lib/cobbler/repo_mirror || exit $?
fi
...
if [[ $SUPPORT_CENTOS_6_6 == "y" ]]; then
    ...
    # download packages
    download $CENTOS_6_6_PPA_REPO_SOURCE unzip /var/lib/cobbler/repo_mirror || exit $?
fi
...
if [[ $SUPPORT_CENTOS_7_0 == "y" ]]; then
    ...
    # download packages
    download $CENTOS_7_0_PPA_REPO_SOURCE unzip /var/lib/cobbler/repo_mirror || exit $?
fi
...
if [[ $SUPPORT_UBUNTU_12_04 == "y" ]]; then
    ...
    download $UBUNTU_12_04_PPA_REPO_SOURCE unzip /var/lib/cobbler/repo_mirror || exit $?
fi
...
if [[ $SUPPORT_UBUNTU_14_04 == "y" ]]; then
    ...
    download $UBUNTU_14_04_PPA_REPO_SOURCE unzip /var/lib/cobbler/repo_mirror || exit $?
fi
